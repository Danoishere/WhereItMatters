...
using WhereItMatters.Admin.Data;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ApplicationDbContext>(options =>
                options.UseSqlServer(Configuration.GetConnectionString("DbConnection_DEV")));
            ...
            services.AddScoped<System.Data.Entity.DbContext>(_ => new DataContext());
            ...
            services.AddScoped<IRepository<BudgetItem>, BaseRepository<BudgetItem>>();
